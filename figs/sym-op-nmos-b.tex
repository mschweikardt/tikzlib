\newcommand{\SymOpNmosB}
{
  \newcommand\diffpairdist{3}
    ...
    \draw (mnd1b.drain) to [short,-,f<=$I_{\mathrm{1,B}}$] ++ (0,2) 
    ...
    \draw (mpcm2r.drain) to [short,*-]  (mpcm2r.drain-|mpcm2r.gate)
                         ...
                         to [short,-]  (mpcm2r.gate-|mpcm3a.drain)
                         to [short,-] ++ (2,0)
                         node [pmos,anchor=gate] (mpcm2a) {}; 

    \draw (mpcm2a.drain) to [short,-] ++ (0,-0.1)
                          node [pmos,anchor=source] (mpc1b) {}; 

    \draw (mpcm3a.drain) to [short,-] (mpcm3a.drain|-mpc1b.source)
                          node [pmos,anchor=source] (mpc1a) {}; 

    \node[nmos,anchor=source,xscale=-1] (mncm4r) at (mncm1a.source-|mpcm3a.drain) {};
    \node[nmos,anchor=source] (mncm4a) at (mncm1a.source-|mpcm2a.drain) {};


    \draw (mncm4r.drain) to [short,-,f<=$I_{\mathrm{3}}$] ++ (0,0.8)
                          node [nmos,anchor=source] (mnc2a) {}; 

    \draw (mncm4a.drain) to [short,-,f<=$I_{\mathrm{4}}$] (mncm4a.source|-mnc2a.source)
                          node [nmos,anchor=source] (mnc2b) {};   

    \draw (mnc2a.drain) to [short,-] (mpc1a.drain);
    \draw (mnc2b.drain) to [short,-] (mpc1b.drain);

    \draw (mncm4a.gate) to[short,-] (mncm4r.gate)
                        to[short,*-] (mncm4r.drain-|mncm4r.gate)
                        to[short,-*] (mncm4r.drain);
    ...
    \draw (mnc2b.gate) -- (mnc2a.gate)
          to [short,-o] ++ (-0.1,0)  
          node [anchor=east] () {BN}; 
    \draw (mpc1b.gate) -- (mpc1a.gate)
          to [short,-o] ++ (-0.1,0)  
          node [anchor=east] () {BP}; 
    ...
    \coordinate (outi) at ($(mpc1b.drain)!0.5!(mnc2b.drain)$);
    ...
    \node[ anchor    = west
         , inner sep = 2pt
         , font      = \footnotesize
         ] () at ($(mpc1a.drain)!0.775!(mpc1a.source)$) {MPC1A};
    \node[ anchor    = west
         , inner sep = 2pt
         , font      = \footnotesize
         ] () at ($(mpc1b.drain)!0.775!(mpc1b.source)$) {MPC1B};
    \node[ anchor    = west
         , inner sep = 2pt
         , font      = \footnotesize
         ] () at ($(mnc2a.source)!0.775!(mnc2a.drain)$) {MNC2A};
    \node[ anchor    = west
         , inner sep = 2pt
         , font      = \footnotesize
         ] () at ($(mnc2b.source)!0.775!(mnc2b.drain)$) {MNC2B}; 
}